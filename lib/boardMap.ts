const boardMap: Record<string, Record<'women' | 'men', string | undefined>> = {
  ...
  corporate:  { women: process.env.PINTEREST_WOMEN_CORPORATE, men: process.env.PINTEREST_MEN_CORPORATE },
  family:     { women: process.env.PINTEREST_WOMEN_FAMILY,    men: process.env.PINTEREST_MEN_FAMILY },
